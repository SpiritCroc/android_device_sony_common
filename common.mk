...
# Common etc
PRODUCT_COPY_FILES += \
    device/sony/common/rootdir/system/vendor/etc/audio_effects.conf:system/vendor/etc/audio_effects.conf.bak \
    ...
    device/sony/common/rootdir/system/etc/sec_config:system/etc/sec_config.bak \
